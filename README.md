...
A versatile speech editor for changing the prosody (pitch, duration, and loudness), pronunciation, or speaker identity (i.e., voice conversion) of recorded speech. Official code for the paper _Fine-Grained and Interpretable Neural Speech Editing_.
